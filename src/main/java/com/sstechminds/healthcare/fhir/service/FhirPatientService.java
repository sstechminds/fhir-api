package com.sstechminds.healthcare.fhir.service;

import ca.uhn.fhir.context.FhirContext;
import ca.uhn.fhir.rest.api.MethodOutcome;
import com.sstechminds.healthcare.fhir.builder.DiagnosticReportBuilder;
import com.sstechminds.healthcare.fhir.dicom.DicomTagBuilder;
...
import com.sstechminds.healthcare.fhir.model.mapper.DiagnosticReportMap;
import com.sstechminds.healthcare.fhir.model.mapper.DiagnosticReportsMap;
import com.sstechminds.healthcare.fhir.model.mapper.ImagingStudyMap;
import com.sstechminds.healthcare.fhir.model.mapper.PatientConditionMap;
import com.sstechminds.healthcare.fhir.model.mapper.PatientMap;
import com.sstechminds.healthcare.fhir.repository.FhirRepository;
...
//  }
  ...
  private boolean includeRecordByDate(Date issuedDate, String inputDate) {
    return (inputDate == null) || DateUtil.formatToLocalDate(issuedDate).equals(DateUtil.parseToLocalDate(inputDate));
  }
