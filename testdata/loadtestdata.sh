...
#curl -X POST  http://localhost:8089/baseDstu3/Patient -H 'apikey:dd6f7f1d-1586-438f-8d35-ff589a12f4df' -H "Content-Type: application/fhir+json" -d "{ \"resourceType\": \"Patient\" , \"id\": \"post-curl\" , \"name\": [ { \"family\": \"GUMERCINDO\", \"given\": [ \"ALMEIDA\", \"PEREIRA\" ] } ] , \"gender\": \"male\" , \"birthDate\": \"1970-01-21\"}"
